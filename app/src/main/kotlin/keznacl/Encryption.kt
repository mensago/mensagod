 ...
 * speed and security.
 */
fun getPreferredAsymmetricAlgorithm(): String { return "CURVE25519" }
...
class EncryptionPair private constructor(publicKeyStr: CryptoString, privateKeyStr: CryptoString):
     KeyPair(publicKeyStr, privateKeyStr), Encryptor {

    override fun canEncrypt(): Boolean { return true }
    override fun canSign(): Boolean { return false }
