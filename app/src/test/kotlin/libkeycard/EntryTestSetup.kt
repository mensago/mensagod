...
fun makeCompliantOrgEntry(): Result<Pair<Entry, Map<String, CryptoString>>> {
    ...
    val outMap = mapOf(
        "primary.public" to primarySPair.pubKey,
        "primary.private" to primarySPair.privKey,
        "secondary.public" to secondarySPair.pubKey,
        "secondary.private" to secondarySPair.privKey,
        "encryption.public" to ePair.pubKey,
        "encryption.private" to ePair.privKey
    )
    ...
    val cardData =
        "Type:Organization\r\n" +
                ...
                "Language:en\r\n" +
                "Primary-Verification-Key:${primarySPair.pubKey}\r\n" +
                "Secondary-Verification-Key:${secondarySPair.pubKey}\r\n" +
                "Encryption-Key:${ePair.pubKey}\r\n" +
                "Time-To-Live:14\r\n" +
                "Expires:2025-06-01\r\n" +
...
fun makeCompliantUserEntry(): Result<Pair<Entry, Map<String, CryptoString>>> {
    ...
    val outMap = mapOf(
        "orgsigning.public" to orgSPair.pubKey,
        "orgsigning.private" to orgSPair.privKey,

        "crsigning.public" to crSPair.pubKey,
        "crsigning.private" to crSPair.privKey,
        "crencryption.public" to crEPair.pubKey,
        "crencryption.private" to crEPair.privKey,
        "signing.public" to sPair.pubKey,
        "signing.private" to sPair.privKey,
        "encryption.public" to ePair.pubKey,
        "encryption.private" to ePair.privKey
    )
    ...
    val cardData =
        "Index:1\r\n" +
                ...
                "User-ID:csimons\r\n" +
                "Domain:example.com\r\n" +
                "Contact-Request-Verification-Key:${crSPair.pubKey}\r\n" +
                "Contact-Request-Encryption-Key:${crEPair.pubKey}\r\n" +
                "Verification-Key:${sPair.pubKey}\r\n" +
                "Encryption-Key:${ePair.pubKey}\r\n" +
                "Time-To-Live:14\r\n" +
                "Expires:2025-06-01\r\n" +
                "Timestamp:2022-05-20T12:00:00Z\r\n"
